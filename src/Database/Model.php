...
class Model
{
    ...
    public function __construct() 
    {
        ...
        if(isset($this->config[$this->setting]['prefix']) && $this->config[$this->setting]['prefix']){
            $this->table_name = $this->config[$this->setting]['prefix'].$this->table_name;
            self::$prefix = $this->config[$this->setting]['prefix'];
        }
    }
